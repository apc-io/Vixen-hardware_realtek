...
static const char DRIVER_MODULE_NAME[]  = "8192cu";
static const char DRIVER_MODULE_TAG[]   = "wlan";
static const char DRIVER_MODULE_PATH[]  = "/system/modules/3.4.5-default/8192cu.ko";
static const char DRIVER_MODULE_ARG[]   = "ifname=wlan0 if2name=p2p0";
#else
